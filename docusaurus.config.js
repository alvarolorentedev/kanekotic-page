...
const config = {
  ...
  projectName: 'kanekotic-page', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/kanekotic/kanekotic-page/tree/main/',
        },
        blog: {
            ...
            items: [
              {
                ...
                href: 'https://stackoverflow.com/questions/tagged/kanekotic',
              },
              {
                label: 'Twitter',
